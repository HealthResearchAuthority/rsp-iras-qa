...
Feature: Run Axe Accessibilty Test Tool Against App Pages
  ...
  Scenario: Creating another modification displays error message
    Given I have navigated to the my research projects page
    And I can see the my research projects page
    And I click the 'Create_Project_Record' button on the 'My_Research_Projects_Page'
    And I click the 'Start' button on the 'Create_Project_Record_Page'
  ...
  Scenario: Submit another in draft modification to sponsor and displays error message
    Given I have navigated to the my research projects page
    And I can see the my research projects page
    And I click the 'Create_Project_Record' button on the 'My_Research_Projects_Page'
    And I click the 'Start' button on the 'Create_Project_Record_Page'
    ...
    And I click the 'Create_New_Modification' button on the 'Project_Overview_Page'
    And I can see the select area of change page
    And I keep note of the individual and overall ranking of changes created using 'Multiple_Changes_Non_Reviewable_Set_Two' and 'Nhs_Involvement_Yes' dataset
    And I create 'Multiple_Changes_Non_Reviewable_Set_Two' for the created modification
    And I can see the modifications details page
    When I click the 'Save_Continue_Review' button on the 'Modification_Details_Page'
    Then I fill the sponsor reference modifications page with 'Valid_Data_All_Fields'
    When I click the 'Save_Continue_Review' button on the 'Sponsor_Reference_Page'
