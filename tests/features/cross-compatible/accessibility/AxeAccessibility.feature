...
Feature: Run Axe Accessibilty Test Tool Against App Pages
  ...
  @axeAccessibilityConfirmProjectDetails @ApplicantUser
  Scenario: Confirm Project details
    Given I have navigated to the my research projects page
    And I click the 'Create_Project_Record' button on the 'My_Research_Projects_Page'
    When I click the 'Start' button on the 'Create_Project_Record_Page'
    Then I can see the project details iras page
  ...
  @axeAccessibilityPostApprovalPageSearchAndAdvancedFilters @ApplicantUser
  Scenario: Project overview post approvals page with advanced filters
    Given I have navigated to the my research projects page
    And I can see the my research projects page
    And I click the 'Create_Project_Record' button on the 'My_Research_Projects_Page'
    When I click the 'Start' button on the 'Create_Project_Record_Page'
    ...
    And I can see the results matching the search 'Partial_Modification_ID' and filter criteria 'Advanced_Filter_All_Fields' for post approval page
    When I Scan the page with the Axe Accessibilty Tool
    And I analyse the results from the Axe scan
    Then I expect to receive no WCAG Violations
  ...
  @axeAccessibilityProjectOverviewProjectTab @ApplicantUser
  Scenario: Project documents page
    Given I have navigated to the my research projects page
    And I can see the my research projects page
    And I click the 'Create_Project_Record' button on the 'My_Research_Projects_Page'
    And I click the 'Start' button on the 'Create_Project_Record_Page'
  ...
  @axeAccessibilityMyOrganisationsPage @SponsorUser @SetupNewSponsorOrgGoLive
  Scenario: My Organisations Page
    Given I have navigated to the 'System_Administration_Page' as 'System_Admin'
    And I click the 'Manage_Sponsor_Organisations' link on the 'System_Administration_Page'
    And I click the 'Setup_New_Sponsor_Organisation' link on the 'Manage_Sponsor_Organisations_Page'
    When I select a sponsor organisation in the set up a new sponsor organisation page using 'Sponsor_Organisation_UniversityOfSouthampton'
  ...
  @axeAccessibilitySponsorOrganisationProfilePage @SponsorUser @SetupNewSponsorOrgGoLive
  Scenario: Sponsor Organisation Profile Projects Tab view
    Given I have navigated to the 'System_Administration_Page' as 'System_Admin'
    And I click the 'Manage_Sponsor_Organisations' link on the 'System_Administration_Page'
    And I click the 'Setup_New_Sponsor_Organisation' link on the 'Manage_Sponsor_Organisations_Page'
    When I select a sponsor organisation in the set up a new sponsor organisation page using 'Sponsor_Organisation_UniversityOfSouthampton'
  ...
  @axeAccessibilityCreateModificationErrorPage @ApplicantUser @SysAdminUser @SponsorUser
  Scenario: Creating another draft modification displays error message
    Given I have navigated to the my research projects page
    And I can see the my research projects page
    And I click the 'Create_Project_Record' button on the 'My_Research_Projects_Page'
    And I click the 'Start' button on the 'Create_Project_Record_Page'
    ...
    When I click the 'Post_Approval' link on the 'Project_Overview_Page'
    And I click the 'Create_New_Modification' button on the 'Project_Overview_Page'
    And I keep note of the individual and overall ranking of changes created using 'Multiple_Changes_Bulk_Free_Text_Combined_Reviewable_Non_Reviewable' and 'Nhs_Involvement_Yes' dataset
    And I create 'Multiple_Changes_Bulk_Free_Text_Combined_Reviewable_Non_Reviewable' for the created modification
    And I can see the modifications details page
    And I validate the project information labels using dataset displayed on modifications page
    When I click the 'Save_For_Later' button on the 'Select_Area_Of_Change_Page'
  ...
  @axeAccessibilitySubmittingToSponsorErrorPage @ApplicantUser @SysAdminUser @SponsorUser
  Scenario: One modification is with review body and trying to submit another modification to review body displays error message
    Given I have navigated to the 'System_Administration_Page' as 'System_Admin'
    And I click the 'Manage_Sponsor_Organisations' link on the 'System_Administration_Page'
    And I click the 'Setup_New_Sponsor_Organisation' link on the 'Manage_Sponsor_Organisations_Page'
    When I select a sponsor organisation in the set up a new sponsor organisation page using 'Sponsor_Organisation_UniversityOfSouthampton'
  ...
  @axeAccessibilityMyOrganisationsConfirmUserStatusPage @SysAdminUser @SetupNewSponsorOrgGoLive
  Scenario: My organisations confirm user status page
    Given I have navigated to the 'System_Administration_Page' as 'System_Admin'
    And I click the 'Manage_Sponsor_Organisations' link on the 'System_Administration_Page'
    And I click the 'Setup_New_Sponsor_Organisation' link on the 'Manage_Sponsor_Organisations_Page'
    When I select a sponsor organisation in the set up a new sponsor organisation page using 'Sponsor_Organisation_UniversityOfSouthampton'
    ...
    And I click the 'View_This_Sponsor_Org_List_Of_Users' link on the 'Sponsor_Organisation_Profile_Page'
    And I click the 'Add_A_New_User_Profile_Record' link on the 'Sponsor_Org_User_List_Page'
    And I enter 'system admin email' into the search field
    And I click the 'Search' button on the 'Search_Add_User_Sponsor_Org_Page'
    ...
    And I click the 'Users' link on the 'My_Organisations_Sponsor_Org_Profile_Page'
    Then I can see the users tab in the sponsor organisation profile for the selected sponsor organisation 'University of Southampton'
  ...
  @axeAccessibilityCloseProjectPage @ApplicantUser
  Scenario: Close project page
    Then I have navigated to the 'My_Research_Page' as 'Applicant_User'
    And I click the 'Create_Project_Record' button on the 'My_Research_Projects_Page'
    And I click the 'Start' button on the 'Create_Project_Record_Page'
    And I fill the unique iras id in project details iras page
  ...
  @axeAccessibilityCloseProjectConfirmationPage @ApplicantUser
  Scenario: Close project confirmation page
    Then I have navigated to the 'My_Research_Page' as 'Applicant_User'
    And I click the 'Create_Project_Record' button on the 'My_Research_Projects_Page'
    And I click the 'Start' button on the 'Create_Project_Record_Page'
    And I fill the unique iras id in project details iras page
  ...
  @axeAccessibilitySponsorProjectClosurePage @ApplicantUser @SetupNewSponsorOrgGoLive
  Scenario: Sponsor project closure page
    Then I have navigated to the 'My_Research_Page' as 'Applicant_User'
    And I click the 'Create_Project_Record' button on the 'My_Research_Projects_Page'
    And I click the 'Start' button on the 'Create_Project_Record_Page'
    And I fill the unique iras id in project details iras page
  ...
  @axeAccessibilityCheckAndAuthoriseProjectClosurePage @ApplicantUser @SetupNewSponsorOrgGoLive
  Scenario: Check and authorise project closure page
    Then I have navigated to the 'My_Research_Page' as 'Applicant_User'
    And I click the 'Create_Project_Record' button on the 'My_Research_Projects_Page'
    And I click the 'Start' button on the 'Create_Project_Record_Page'
    And I fill the unique iras id in project details iras page
  ...
  @axeAccessibilityCheckAndAuthoriseProjectClosureAuthorisedConfirmationPage @ApplicantUser @SetupNewSponsorOrgGoLive
  Scenario: Check and authorise project closure - authorised confirmation page
    Then I have navigated to the 'My_Research_Page' as 'Applicant_User'
    And I click the 'Create_Project_Record' button on the 'My_Research_Projects_Page'
    And I click the 'Start' button on the 'Create_Project_Record_Page'
    And I fill the unique iras id in project details iras page
  ...
  @axeAccessibilityCheckAndAuthoriseProjectClosureAuthorisedSuccessPage @ApplicantUser @SetupNewSponsorOrgGoLive
  Scenario: Check and authorise project closure - authorised success page
    Then I have navigated to the 'My_Research_Page' as 'Applicant_User'
    And I click the 'Create_Project_Record' button on the 'My_Research_Projects_Page'
    And I click the 'Start' button on the 'Create_Project_Record_Page'
    And I fill the unique iras id in project details iras page
  ...
  @axeAccessibilityCheckAndAuthoriseProjectClosureNotAuthorisedSuccessPage @ApplicantUser @SetupNewSponsorOrgGoLive
  Scenario: Check and authorise project closure - not authorised success page
    Then I have navigated to the 'My_Research_Page' as 'Applicant_User'
    And I click the 'Create_Project_Record' button on the 'My_Research_Projects_Page'
    And I click the 'Start' button on the 'Create_Project_Record_Page'
    And I fill the unique iras id in project details iras page
  ...
  Scenario Outline: Studywide Reviewer - Approved with Comments - Comments Tab
    ...
    Then I can see the modification post submission page
    And I capture the page screenshot
    Then I '<Visibility>' see comments tab for the modification record with '<Outcome_Reason>'
    When I Scan the page with the Axe Accessibilty Tool
    And I analyse the results from the Axe scan
    Then I expect to receive no WCAG Violations
  ...
  @axeAccessibilityModificationNotAuthorisedPage @ApplicantUser @SetupNewSponsorOrgGoLive @Release_2.0
  Scenario: Sponsor - Modification not authorised page
    Given I have navigated to the 'System_Administration_Page' as 'System_Admin'
    And I click the 'Manage_Sponsor_Organisations' link on the 'System_Administration_Page'
    And I click the 'Setup_New_Sponsor_Organisation' link on the 'Manage_Sponsor_Organisations_Page'
    When I select a sponsor organisation in the set up a new sponsor organisation page using 'Sponsor_Organisation_UniversityOfSouthampton'
  ...
  Scenario: Edit user profile page of sponsor organisation
    ...
    And I analyse the results from the Axe scan
    Then I expect to receive no WCAG Violations
  @MultiOrgAuthorisationPage @SetupNewSponsorOrgGoLive
  Scenario: Multiple-Organisation Authorisations page
    Given I have navigated to the 'System_Administration_Page' as 'System_Admin'
    And I click the 'Manage_Sponsor_Organisations' link on the 'System_Administration_Page'
    And I click the 'Setup_New_Sponsor_Organisation' link on the 'Manage_Sponsor_Organisations_Page'
    ...
    Then I can see the 'user added' successful message on sponsor organisation user list page
    And I capture the page screenshot
    When I have navigated to the 'Home_Page' as 'Sponsor_User'
  ...
  @MultiOrgAuthorisationPage @SetupNewSponsorOrgGoLive
  Scenario:Authorisations page for a specific sponsor Organisation
    Given I have navigated to the 'System_Administration_Page' as 'System_Admin'
    And I click the 'Manage_Sponsor_Organisations' link on the 'System_Administration_Page'
    And I click the 'Setup_New_Sponsor_Organisation' link on the 'Manage_Sponsor_Organisations_Page'
    When I select a sponsor organisation in the set up a new sponsor organisation page using 'Sponsor_Organisation_AalborgUniversityHospital'
    ...
    And I click the 'Authorisations' link on the 'Sponsor_Workspace_Page'
    Then I capture the page screenshot
    And I can see the associated organisations displaying in the authorisations page for 'Sponsor_User'
    And I click the organisation link 'Sponsor_Organisation_AalborgUniversityHospital' in the authorisations page
    Then I capture the page screenshot
    And I can see the authorisations page for 'Sponsor_Organisation_AalborgUniversityHospital'
    When I Scan the page with the Axe Accessibilty Tool
    And I analyse the results from the Axe scan
    Then I expect to receive no WCAG Violations