@TBDTAG @RegressionTest @SetupNewSponsorOrgGoLive @SponsorUser @jsEnabled
Feature: Review Amendments- As a studywide reviewer I want to receive and reveiw amendments
    # Run Alfred Project/Modification feature generate data for Modifications for all countries
    # Use data to get 4822 tests complete - add to sys test + regression files where needed
    # Get audit history page done for mods
    # Look into 5380 - should be a test to re-use
    # Start sponsor org
    ...
    @rsp-4822 @TBDSCenarioTag @onlyTesting
    Scenario Outline: TBD Scenario Title
