...
Feature: Review Amendments- As a studywide reviewer I want to receive and review amendments
    ...
    @RegressionBackstageReadonlyReviewableModifications @rsp-5380
    Scenario Outline: Ensure the reviewable modification record is read-only in backstage and reflects all the data
        ...
        Then I can see the 'reviewable' modifications details page in the readonly view
        And I validate the project information labels using dataset displayed on modifications page
    ...
    @RegressionBackstageReadonlyNonReviewableModifications @rsp-5036
    Scenario Outline: Ensure the non-reviewable modification record is read-only in backstage and reflects all the data
        Then I fill the research locations page with '<Research_Locations>'
        When I click the 'Save_Continue' button on the 'Research_Locations_Page'
        Then I can see the review your answers page
        And I capture the page screenshot
        ...
        And I enter 'new iras id' into the search field
        And I click the 'Search' button on the '<Backstage_Page>'
        Then I 'can' see the modification displayed in the '<Backstage_Page>' list with 'Modification_Status_Approved' status
        When I click the modification id displayed on the '<Backstage_Page>'
        Then I can see the 'non-reviewable' modifications details page in the readonly view
        And I validate the project information labels using dataset displayed on modifications page
        And I validate the date created for modification in sponsor check and authorise page
        ...
        Examples:
            | Changes                                | Research_Locations  | Backstage_Page            | Backstage_User     |
            | Change_Of_Sponsor_legal_Representative | Nhs_Involvement_Yes | Search_Modifications_Page | Studywide_Reviewer |
