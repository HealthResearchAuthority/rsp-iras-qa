@RegressionEditManageUsers @RegressionManageUsers @adminUser @Regression @TestAllLater
Feature: User Administration: Manage Users
    
    Background:
        # Change to Home Page Nav flow
        Given I have navigated to the 'System_Administration_Page'
        And I click the 'Manage_Users' link on the 'System_Administration_Page'
        And I can see the 'Manage_Users_Page'
        
    @RegressionTestEditCommonUserFields @testThisLater
