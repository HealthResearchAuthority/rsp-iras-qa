...
Feature: Question Set - Research Application - Project Filter & Project Details Demo
    ...
    Scenario Outline: Validate user is able to fill all sections in project filter page for a new research application
        ...
        Examples:
            ...
            | New_Application    | Project_Details_Different | Project_Scope_Common | Research_Location_Common | Protocol_Ref_Number_ABC_Data | No_Involvement           | Valid_Data_In_All_Fields | No_Standard_Of_Care      | Valid_Data_In_All_Fields | Continue          |