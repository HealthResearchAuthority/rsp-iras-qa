...
Feature: Modifications Tasklist page that displays modifications ready to be assigned   
    ...
    Background:
        ...
        And the current page number should be visually highlighted to indicate the active page the user is on in the modifications ready to assign page
        And I capture the page screenshot
