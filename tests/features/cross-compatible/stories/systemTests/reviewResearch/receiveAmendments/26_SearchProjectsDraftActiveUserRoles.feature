@ReceiveAmendments @SearchProjectRecordsSortFilter @SysAdminUser @SystemTest @rsp-5456 @TestSearchProjectRecords
Feature: Display project records on the Search Projects page status and roles
        ...
        @DraftStatusProjectSWRWFCTeamManager @fail @KNOWN_DEFECT-RSP-6416
