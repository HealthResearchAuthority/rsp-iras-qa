@ReceiveAmendments @SearchProjectRecordsSortFilter @SysAdminUser @SystemTest @rsp-5455 @rsp-5456
Feature: Receive Amendments: Filter, Search and Sort the Search project records page for system administrator
        ...
        @TestOnly @SearchProjectsTitleBackLinksNav @DraftStatusProjectSysAdmin
        Scenario: Verify back and short project title link navigation for search projects tasklist of system administrator
        ...
        # There is no back link to navigate back from Project Record Overview page to Search project records page of Approvals workspace
        @TestOnly @SearchProjectsTitleBackLinksNav @ActiveStatusProjectSysAdminSWRWFCTeamManager
        Scenario: Verify back and short project title link navigation for search projects tasklist of all backstage users
                Given I have navigated to the 'My_Research_Page' as 'Applicant_User'
                And I can see the my research projects page
                And I click the 'Create_Project_Record' button on the 'My_Research_Projects_Page'
                And I click the 'Start' button on the 'Create_Project_Record_Page'
