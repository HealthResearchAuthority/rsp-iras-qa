...
Feature: Studywide reviewer receive and not approve amendments
    ...
    Scenario Outline: Verify the modification approvals workflow
        ...
        And I click the 'Sponsor_Organisation_UniversityOfBristol' link on the sponsor workspace page
        ...
        Examples:
            ...
            | Other_Minor_Change_To_Project_Management | Data_With_Lead_Nation_England | Study_Wide_Reviewer_HRA_England | Workflow_Coordinator | Studywide_Reviewer | First_Comment | Not_Approved | Lack_Of_Evidence | Modification_Status_Not_Approved | can        |
            | Other_Minor_Change_To_Project_Management | Data_With_Lead_Nation_England | Study_Wide_Reviewer_HRA_England | Workflow_Coordinator | Studywide_Reviewer | Blank         | Not_Approved | Lack_Of_Evidence | Modification_Status_Not_Approved | cannot     |
