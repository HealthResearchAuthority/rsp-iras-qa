...
Feature: Sponsor authorisation based on permission and role
  ...
  Scenario Outline: Verify that <Login_User> can authorise modifications while adding user from sponsor workspace
    ...
    And I capture the page screenshot
    Then I can see the add user role page
    When I fill the add user role page using '<Another_Registered_User_Role>'
    And I capture the page screenshot
    And I click the 'Save_Continue' button on the 'Add_User_Role_Sponsor_Org_Page'
    And I capture the page screenshot
    And I can see the add user permission page based on '<Another_Registered_User_Permission>'
    When I fill the add user permission page using '<Another_Registered_User_Permission>'
    And I capture the page screenshot
    And I click the 'Save_Continue' button on the 'Add_User_Permission_Sponsor_Org_Page' based on '<Another_Registered_User_Permission>'
    And I capture the page screenshot
    And the check and confirm page to add user to sponsor organisation displays the expected user details for the selected sponsor organisation '<Sponsor_Organisation>' and '<Another_Registered_User_Permission>' and for the user '<Another_Registered_User>'
