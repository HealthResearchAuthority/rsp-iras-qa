...
Feature: User Administration: Manage Review Bodies list and view review bodies profile details   
    ...
    Background:
        ...
        When I click the 'Modifications' link on the 'Approvals page'
        Then I can see the 'Modifications_Ready_To_Assign_Page'
...
#         And I capture the page screenshot
    ...
    @pagination 
        ...
        #THEN I see modification records in a tasklist displaying the following columns: Modification ID, Short project title, Modification type, Date submitted, and Days since submission     
