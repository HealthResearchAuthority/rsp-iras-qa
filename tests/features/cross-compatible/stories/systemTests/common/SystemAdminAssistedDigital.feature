...
Feature: Validate the assisted digital test coverage as system admininstrator for known scenarios
  ...
  @ProjectClosureNotAuthorisedThenAuthorisedForClosureSystemAdmin
  Scenario: Validate a project closure initially not authorised can be authorised later for project closure by system admin
    ...
    And I capture the page screenshot
    Then I click the 'Send_Modification_To_Sponsor' button on the 'Review_All_Changes_Page'
    And I have navigated to the 'Home_Page' as 'System_Admin'
    When I click the 'Sponsor' link on the 'Home_Page'
    And I click the 'Authorisations' link on the 'Sponsor_Workspace_Page'
    When I enter 'modification id' into the search field
    And I click the 'Search' button on the 'Sponsor_Authorisations_Page'
    ...
    And I 'keep note of' the project closure transaction details along with the 'System_Admin' user and 'With sponsor' status
    And I capture the page screenshot
    ...
    And I click the 'Search' button on the 'Sponsor_Authorisations_Page'
    And I capture the page screenshot
    And I 'keep note of' the project closure details for sponsor authorisations view along with the 'System_Admin' user and 'With sponsor' status
    ...
    And I 'update status of' the project closure transaction details along with the 'System_Admin' user and 'Not authorised' status
    And I 'update status of' the project closure details for sponsor authorisations view along with the 'System_Admin' user and 'Not authorised' status
    ...
    And I 'update status of' the project closure transaction details along with the 'System_Admin' user and 'Authorised' status
    And I 'update status of' the project closure details for sponsor authorisations view along with the 'System_Admin' user and 'Authorised' status
    When I click the 'Return_To_Authorisations' button on the 'Confirmation_Page'
    And I capture the page screenshot
    And I click the 'Project_Closures' link on the 'Sponsor_Workspace_Page'
    When I enter 'iras id' into the search field
