...
Feature: This feature covers the sponsor request revision journeys for modifications
  ...
  @rsp-6825 @ReviewableModificationSponsorRequestRevision @Release_2.0
  Scenario Outline: Validate that sponsor can request revisions for reviewable modifications
  ...
  @rsp-6825 @NonReviewableModificationSponsorRequestRevision @Release_2.0
  Scenario Outline: Validate that sponsor can request revisions for non reviewable modifications
    Then I fill the research locations page with '<Research_Locations>'
    When I click the 'Save_Continue' button on the 'Research_Locations_Page'
    Then I can see the review your answers page
    And I capture the page screenshot
  ...
  @rsp-6825 @ReviewableAndNonReviewableModificationSponsorRequestRevision @Release_2.0
  Scenario Outline: Validate that sponsor can request revisions for combination of reviewable and non reviewable modifications
    Then I fill the research locations page with '<Research_Locations>'
    When I click the 'Save_Continue' button on the 'Research_Locations_Page'
    Then I can see the review your answers page
    And I capture the page screenshot
