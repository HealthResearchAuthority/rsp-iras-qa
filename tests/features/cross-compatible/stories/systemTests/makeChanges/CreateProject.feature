...
Feature: Create Amendment - Create Project
  ...
  Scenario Outline: Validate the primary sponsor organisation suggestion list in key project roles page
    ...
    Examples:
      ...
      # | Create_Project_Record   | Start                    | Save_Continue           | Valid_Data_All_Fields | Sponsor_Organisation_Text_Partial_Amp         | Sponsor_Organisation_Invalid_Data | Sponsor_Organisation_Min_Char | Suggestion_List_Common_Headers | RTS_NIHR_FHIR_Config | RTS_Active_Sponsor_Organisation_Amp         |
  ...
  Scenario Outline: Validate the active primary sponsor organisation from rts with data in database
    ...
    Examples:
      ...
      | RTS_NIHR_FHIR_Config | RTS_Active_Sponsor_Organisation_Amp         |
