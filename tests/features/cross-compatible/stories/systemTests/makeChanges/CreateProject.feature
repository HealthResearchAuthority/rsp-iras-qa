...
Feature: Create Amendment - Create Project
  ...
  Background:
    Given I have navigated to the 'My_Research_Projects_Page'
    And I can see the 'My_Research_Projects_Page'
  ...
  Scenario Outline: Validate user is able to amend a project using an iras id
    ...
    Then I click the '<Navigation_Button_1>' button on the 'My_Research_Projects_Page'
