@SponsorReviseAndAuthorise @Regression @SetupNewSponsorOrgGoLive @SponsorUser
Feature: This feature covers the sponsor revise and authorise modifications
# This feature validates the end-to-end modification revise and authorise workflow. 
# When an applicant submits a modification request and sponsor identifies required changes, then sponsor revises the modification request and authorises it.
  ...
  @rsp-6826 @ReviewableModificationSponsorReviseAndAuthorise @Release_2.0
  Scenario Outline: Validate that sponsor can revise and authorise the reviewable modifications
    ...
    And I validate the change details are displayed as per the '<Changes>' dataset for revise and authorise page
  ...
  @rsp-6826 @NonReviewableModificationSponsorReviseAndAuthorise @Release_2.0
  Scenario Outline: Validate that sponsor can revise and authorise the non reviewable modifications
    Then I fill the research locations page with '<Research_Locations>'
    When I click the 'Save_Continue' button on the 'Research_Locations_Page'
    Then I can see the review your answers page
    And I capture the page screenshot
  ...
  @rsp-6826 @ReviewableAndNonReviewableModificationSponsorReviseAndAuthorise @Release_2.0
  Scenario Outline: Validate that sponsor can revise and authorise the combination of reviewable and non reviewable modifications
    Then I fill the research locations page with '<Research_Locations>'
    When I click the 'Save_Continue' button on the 'Research_Locations_Page'
    Then I can see the review your answers page
    And I capture the page screenshot
