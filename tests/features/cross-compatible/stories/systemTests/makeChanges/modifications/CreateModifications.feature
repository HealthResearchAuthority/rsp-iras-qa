...
Feature: Create Amendment - Create Modifications
  ...
  Scenario Outline: Validate changes can be added or removed and modification can be deleted when the modification is in draft status
    ...
    And I capture the page screenshot
    And I can see the modifications details page
    # delete modification from the modification details page here
    ...
    #confirm delete modification success message is displayed - I validate the delete modification success message
    When I click the 'Post_Approval' link on the 'Project_Overview_Page'
    #confirm the modification is not displayed - I validate the deleted modification does not appear in the modification in the post approval tab
    And I capture the page screenshot
    And I click the 'Create_New_Modification' button on the 'Project_Overview_Page'
    And I can see the select area of change page
    And I validate the project information labels using 'Valid_Data_All_Fields' dataset displayed on modifications page
  ...
  @rsp-5341 @ValidateDocumentsAdditionAndDeletionInStatusIndraft @abc
  Scenario Outline: Validate documents can be added or removed when the modification is in draft status
  # Then I fill the research locations page with 'Nhs_Involvement_Yes'
  # When I click the 'Save_Continue' button on the 'Research_Locations_Page'
  # Then I can see the review your answers page
  # And I capture the page screenshot
  ...
  @rsp-5341 @ValidateNonReviewableModificationStatusesInDraftAndWithSponsor
  Scenario Outline: Validate modification status transition from in draft to with sponsor for non reviewable modification
    Then I fill the research locations page with 'Nhs_Involvement_Yes'
    When I click the 'Save_Continue' button on the 'Research_Locations_Page'
    Then I can see the review your answers page
    And I capture the page screenshot
  ...
  Scenario Outline: Validate modification status transition from in draft to with sponsor or with regulator for reviewable modification or combination of reviewable and non reviewable modifications
