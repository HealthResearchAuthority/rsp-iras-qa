@ApplicantUser @createModifications @ProjectPersonnelChangePrincipalInvestigatorModifications @SystemTest @jsEnabled
Feature: Create Amendment - Project Personnel Change Principal Investigator Modifications
