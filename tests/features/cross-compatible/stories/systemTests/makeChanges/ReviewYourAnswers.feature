...
Feature: Create Amendment - Create Project - Review your answers
  ...
  Scenario Outline: Verify that user has not completed all questions and can enter research locations details from review your answers page
    ...
    Examples:
      ...
      | Valid_Data_Title_Empty_Field | Valid_Data_All_Empty_Fields | Valid_Data_All_Empty_Fields | nations_participating | Enter_Links_Missing_Fields | Valid_Data_All_Fields                   | Sponsor_Organisation_Text_Blank |
      | Valid_Data_Title_Empty_Field | Valid_Data_All_Empty_Fields | Valid_Data_All_Empty_Fields | nations_participating | Enter_Links_Missing_Fields | Valid_Data_Only_Nations_Participating   | Sponsor_Organisation_Text_Blank |
  ...
  Scenario Outline: Validate error message on project title page when user redirected from review your answers page
    ...
    Examples:
      ...
      | Valid_Data_All_Empty_Fields | Valid_Data_All_Empty_Fields | Valid_Data_All_Empty_Fields | Project_Title    | Enter_Links_Missing_Fields | Invalid_Data_Short_Project_Title_Max_Length | Title_Field_Error_Message       | Sponsor_Organisation_Text_Blank |
      | Valid_Data_All_Empty_Fields | Valid_Data_All_Empty_Fields | Valid_Data_All_Empty_Fields | Project_Title    | Enter_Links_Missing_Fields | Invalid_Data_Short_Project_Title_Min_Length | Title_Field_Error_Message       | Sponsor_Organisation_Text_Blank |
  ...
  Scenario Outline: Validate chief investigator email error messages when user redirected from review your answers page
    ...
    Examples:
      ...
      | Valid_Data_Title_Empty_Field | Valid_Data_All_Empty_Fields | Valid_Data_All_Empty_Fields | chief_investigator_email | Enter_Links_Missing_Fields | Invalid_Email_Data_One_Start_With_Dot  | Field_Error_Chief_Email         | Sponsor_Organisation_Text_Blank |
      | Valid_Data_Title_Empty_Field | Valid_Data_All_Empty_Fields | Valid_Data_All_Empty_Fields | chief_investigator_email | Enter_Links_Missing_Fields | Invalid_Email_Data_One_Double_Dot      | Field_Error_Chief_Email         | Sponsor_Organisation_Text_Blank |
      | Valid_Data_Title_Empty_Field | Valid_Data_All_Empty_Fields | Valid_Data_All_Empty_Fields | chief_investigator_email | Enter_Links_Missing_Fields | Invalid_Email_Data_One_TLD             | Field_Error_Chief_Email         | Sponsor_Organisation_Text_Blank |
      | Valid_Data_Title_Empty_Field | Valid_Data_All_Empty_Fields | Valid_Data_All_Empty_Fields | chief_investigator_email | Enter_Links_Missing_Fields | Invalid_Email_Data_One_Reserved_Domain | Field_Error_Chief_Email         | Sponsor_Organisation_Text_Blank |
      | Valid_Data_Title_Empty_Field | Valid_Data_All_Empty_Fields | Valid_Data_All_Empty_Fields | chief_investigator_email | Enter_Links_Missing_Fields | Invalid_Email_Data_One_Punycode        | Field_Error_Chief_Email         | Sponsor_Organisation_Text_Blank |
      | Valid_Data_Title_Empty_Field | Valid_Data_All_Empty_Fields | Valid_Data_All_Empty_Fields | chief_investigator_email | Enter_Links_Missing_Fields | Invalid_Email_Data_One_Max_Char        | Field_Error_Chief_Email         | Sponsor_Organisation_Text_Blank |
  # | Valid_Data_Title_Empty_Field | Valid_Data_All_Empty_Fields | Valid_Data_All_Empty_Fields | chief_investigator_email | Enter_Links_Missing_Fields | Invalid_Email_Data_One_Space                           | Field_Error_Chief_Email         |Sponsor_Organisation_Text_Blank|
  # | Valid_Data_Title_Empty_Field | Valid_Data_All_Empty_Fields | Valid_Data_All_Empty_Fields | chief_investigator_email | Enter_Links_Missing_Fields | Invalid_Email_Data_One_Wrong_AT                        | Field_Error_Chief_Email         |Sponsor_Organisation_Text_Blank|
  # | Valid_Data_Title_Empty_Field | Valid_Data_All_Empty_Fields | Valid_Data_All_Empty_Fields | chief_investigator_email | Enter_Links_Missing_Fields | Invalid_Email_Data_One_Less_Greater_Symbols            | Field_Error_Chief_Email         |Sponsor_Organisation_Text_Blank|
  # | Valid_Data_Title_Empty_Field | Valid_Data_All_Empty_Fields | Valid_Data_All_Empty_Fields | chief_investigator_email | Enter_Links_Missing_Fields | Invalid_Email_Data_One_Colon                           | Field_Error_Chief_Email         |Sponsor_Organisation_Text_Blank|
  # | Valid_Data_Title_Empty_Field | Valid_Data_All_Empty_Fields | Valid_Data_All_Empty_Fields | chief_investigator_email | Enter_Links_Missing_Fields | Invalid_Email_Data_One_Semi_Colon                      | Field_Error_Chief_Email         |Sponsor_Organisation_Text_Blank|
  # | Valid_Data_Title_Empty_Field | Valid_Data_All_Empty_Fields | Valid_Data_All_Empty_Fields | chief_investigator_email | Enter_Links_Missing_Fields | Invalid_Email_Data_One_Comma                           | Field_Error_Chief_Email         |Sponsor_Organisation_Text_Blank|
  # | Valid_Data_Title_Empty_Field | Valid_Data_All_Empty_Fields | Valid_Data_All_Empty_Fields | chief_investigator_email | Enter_Links_Missing_Fields | Invalid_Email_Data_One_Start_With_Hyphen               | Field_Error_Chief_Email         |Sponsor_Organisation_Text_Blank|
  # | Valid_Data_Title_Empty_Field | Valid_Data_All_Empty_Fields | Valid_Data_All_Empty_Fields | chief_investigator_email | Enter_Links_Missing_Fields | Invalid_Email_Data_One_Hyphen_Before_Domain            | Field_Error_Chief_Email         |Sponsor_Organisation_Text_Blank|
  # | Valid_Data_Title_Empty_Field | Valid_Data_All_Empty_Fields | Valid_Data_All_Empty_Fields | chief_investigator_email | Enter_Links_Missing_Fields | Invalid_Email_Data_One_Double_Dot_Domain               | Field_Error_Chief_Email         |Sponsor_Organisation_Text_Blank|
  # | Valid_Data_Title_Empty_Field | Valid_Data_All_Empty_Fields | Valid_Data_All_Empty_Fields | chief_investigator_email | Enter_Links_Missing_Fields | Invalid_Email_Data_One_Exclamation_Domain              | Field_Error_Chief_Email         |Sponsor_Organisation_Text_Blank|
  # | Valid_Data_Title_Empty_Field | Valid_Data_All_Empty_Fields | Valid_Data_All_Empty_Fields | chief_investigator_email | Enter_Links_Missing_Fields | Invalid_Email_Data_One_Unicode                         | Field_Error_Chief_Email         |Sponsor_Organisation_Text_Blank|
  # | Valid_Data_Title_Empty_Field | Valid_Data_All_Empty_Fields | Valid_Data_All_Empty_Fields | chief_investigator_email | Enter_Links_Missing_Fields | Invalid_Email_Data_One_Single_Quote_Before_AT          | Field_Error_Chief_Email         |Sponsor_Organisation_Text_Blank|
  # | Valid_Data_Title_Empty_Field | Valid_Data_All_Empty_Fields | Valid_Data_All_Empty_Fields | chief_investigator_email | Enter_Links_Missing_Fields | Invalid_Email_Data_One_Domain_Exceed_Max               | Field_Error_Chief_Email         |Sponsor_Organisation_Text_Blank|
  # | Valid_Data_Title_Empty_Field | Valid_Data_All_Empty_Fields | Valid_Data_All_Empty_Fields | chief_investigator_email | Enter_Links_Missing_Fields | Invalid_Email_Data_One_Local_Part_Max                  | Field_Error_Chief_Email         |Sponsor_Organisation_Text_Blank|
  # | Valid_Data_Title_Empty_Field | Valid_Data_All_Empty_Fields | Valid_Data_All_Empty_Fields | chief_investigator_email | Enter_Links_Missing_Fields | Invalid_Email_Data_One_Consecutive_Dot_Domain          | Field_Error_Chief_Email         |Sponsor_Organisation_Text_Blank|
  # | Valid_Data_Title_Empty_Field | Valid_Data_All_Empty_Fields | Valid_Data_All_Empty_Fields | chief_investigator_email | Enter_Links_Missing_Fields | Invalid_Email_Data_One_Consecutive_Dot_SubDomain       | Field_Error_Chief_Email         |Sponsor_Organisation_Text_Blank|
  # | Valid_Data_Title_Empty_Field | Valid_Data_All_Empty_Fields | Valid_Data_All_Empty_Fields | chief_investigator_email | Enter_Links_Missing_Fields | Invalid_Email_Data_One_Consecutiv_Dot_Domain_SubDomain | Field_Error_Chief_Email         |Sponsor_Organisation_Text_Blank|
  # | Valid_Data_Title_Empty_Field | Valid_Data_All_Empty_Fields | Valid_Data_All_Empty_Fields | chief_investigator_email | Enter_Links_Missing_Fields | Invalid_Email_Data_One_Emoji                           | Field_Error_Chief_Email         |Sponsor_Organisation_Text_Blank|
  ...
  Scenario Outline: Validate error message on project title page when user redirected from review your answers page - change flow
    ...
    Examples:
      ...
      | Valid_Data_All_Fields | Valid_Data_All_Fields | Valid_Data_All_Fields | Project_Title     | Invalid_Data_Short_Project_Title_Max_Length | Title_Field_Error_Message       | Valid_Data_All_Fields |
      | Valid_Data_All_Fields | Valid_Data_All_Fields | Valid_Data_All_Fields | Project_Title     | Invalid_Data_Short_Project_Title_Min_Length | Title_Field_Error_Message       | Valid_Data_All_Fields |
  ...
  Scenario Outline: Validate user is able to see the error messages when user submit the review answer page when all mandatory fields are not entered correctly
    ...
    Examples:
      ...
      | Create_Project_Record   | Start                    | Save_Continue           | Confirm_Project_Details  | Valid_Data_Only_Title_Field | Valid_Data_All_Empty_Fields              | Valid_Data_All_Empty_Fields                 | Field_Error_Message_Except_Project_Title           | Sponsor_Organisation_Text_Blank |
