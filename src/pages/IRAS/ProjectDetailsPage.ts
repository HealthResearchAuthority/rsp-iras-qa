...
export default class ProjectDetailsPage {
  ...
  readonly select_type_questions_used_checkobox: Locator;
  ...
  constructor(page: Page) {
    ...
    this.aspects_already_actively_involved_checkbox = this.public_involvement_section.getByTestId(RegExp('^IQA0045'));
    ...
    this.how_identified_involved_contributors_checkbox = this.public_involvement_section.getByTestId(
      RegExp('^IQA0042')
    );
    ...
    this.how_plan_involve_contributors_remaining_stages_checkbox = this.public_involvement_section.getByTestId(
      RegExp('^IQA0162')
    );
    ...
    this.methods_using_checkbox = this.research_design_section.getByTestId(RegExp('^IQA0049'));
    ...
    this.is_novel_intervention_trial_radio = this.research_design_section.getByTestId(RegExp('^IQA0054_OPT0004'));
    this.is_compare_interventions_trial_radio = this.research_design_section.getByTestId(RegExp('^IQA0055_OPT0004'));
    this.is_intervention_gold_standard_radio = this.research_design_section.getByTestId(RegExp('^IQA0056_OPT0004'));
    ...
    this.does_project_use_ai_checkbox = this.research_design_section.getByTestId(RegExp('IQA03277'));
    this.developing_best_describe_ai_type_checkbox = this.research_design_section.getByTestId(RegExp('^IQA03278'));
    this.describe_ai_type_text = this.research_design_section.getByTestId('IQA03279_Text');
    this.existing_best_describe_ai_type_checkbox = this.research_design_section.getByTestId(RegExp('^IQA03280'));
    ...
    this.is_treatment_first_human_radio = this.research_activities_section.getByTestId(RegExp('^IQA0063'));
    this.does_involve_change_delay_care_radio = this.research_activities_section.getByTestId(RegExp('^IQA0064'));
    this.are_treatments_compared_standard_care_radio = this.research_activities_section.getByTestId(RegExp('^IQA0065'));
    this.describe_arrangements_to_address_changes_text = this.research_activities_section.getByTestId('IQA0066_Text');
    this.select_type_questions_used_checkobox = this.research_activities_section.getByTestId(RegExp('^IQA03273'));
    this.is_possible_sensitive_topics_radio = this.research_activities_section.getByTestId(RegExp('^IQA0068'));
    this.is_possible_criminal_disclosures_radio = this.research_activities_section.getByTestId(RegExp('^IQA0070'));
    ...
    this.will_inform_participant_gp_radio = this.research_activities_section.getByTestId(RegExp('^IQA0077'));
    this.explain_circumstance_gp_contact_text = this.research_activities_section.getByTestId('IQA0078_Text');
    this.what_will_happen_treatment_when_finished_will_continue_radio = this.research_activities_section.getByTestId(
      RegExp('^IQA0079')
    );
    ...
    this.primary_conditions_problems_checkbox = this.participants_section.getByTestId(RegExp('^IQA0083'));
    ...
    this.groups_participate_provide_samples_checkbox = this.participants_section.getByTestId(RegExp('^IQA0088'));
