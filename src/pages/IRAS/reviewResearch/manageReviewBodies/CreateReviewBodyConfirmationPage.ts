...
import * as createReviewBodyConfirmationPageData from '../../../../resources/test_data/iras/reviewResearch/manageReviewBodies/pages/create_review_body_confirmation_page_data.json';
