...
export default class SearchAddUserSponsorOrganisationPage {
  ...
  constructor(page: Page) {
    ...
    // this.search_input_label = this.page
    //   .getByRole('textbox')
    //   .getByText(this.searchAddUserSonsorOrgPageTestData.Add_A_New_User_Page.search_input_label, { exact: true });
  ...
  async assertOnSearchAddUserSponsorOrganisationPage() {
    ...
    // await expect.soft(this.search_input_label).toBeVisible();
