...
export default class SearchAddUserSponsorOrganisationPage {
  ...
  constructor(page: Page) {
    ...
    this.search_input_label = this.page.getByText(
      this.searchAddUserSonsorOrgPageTestData.Add_A_New_User_Page.search_input_label,
      { exact: true }
    );
    this.search_guidance_text = this.page
      .getByRole('paragraph')
      .getByText(this.searchAddUserSonsorOrgPageTestData.Add_A_New_User_Page.search_guidance_text, {
        exact: true,
      });
