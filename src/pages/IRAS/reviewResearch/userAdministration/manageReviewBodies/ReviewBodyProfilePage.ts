...
export default class ReviewBodyProfilePage {
  ...
  readonly reviewbodyTableRows: Locator;
  ...
  constructor(page: Page) {
    ...
    this.reviewbodyTableRows = this.page.getByRole('table').getByRole('row');
    // this.organisation_name_label = this.reviewbodyTableRows
    //   .getByRole('cell')
    //   .getByText(this.reviewBodyProfilePageData.Review_Body_Profile_Page.organisation_name_label, { exact: true });
    // this.organisation_name_text = this.reviewbodyTableRows
    //   .getByRole('cell')
    //   .getByTestId(this.reviewBodyProfilePageData.Review_Body_Profile_Page.organisation_name_label)
    //   .locator('..');
    // this.organisation_change_link = this.organisation_name_text.locator('..').getByText('Change');
  }
