...
export default class KeyProjectRolesPage {
  ...
  constructor(page: Page) {
    ...
    this.chief_investigator_email_label = this.page.locator('div[id="chief-investigator-hint"]');
    this.sponsor_contact_header_label = this.page.locator('label[for="IQA0313_Text"]');
    this.sponsor_contact_email_label = this.page.locator('div[id="sponsor-contact-hint"]');
    ...
    this.primary_sponsor_organisation_jsenabled_text = this.page.locator(
      'div[id="Questions[1].AnswerText"] input[id="input-autocomplete"]'
    );
    this.primary_sponsor_organisation_suggestion_list_labels = this.page.locator(
      'div[id="Questions[1].AnswerText"] ul[role="listbox"] li'
    );
  }
