...
export default class ProjectDetailsTitlePage {
  ...
  constructor(page: Page) {
    ...
    this.year_textbox_label = this.page.locator('label[for="Questions[0].Year"]');
    this.planned_project_end_day_text = this.page.getByTestId('Questions[0].Day');
    this.planned_project_end_month_dropdown = this.page.getByTestId('Questions[0].Month');
    this.planned_project_end_year_text = this.page.getByTestId('Questions[0].Year');
