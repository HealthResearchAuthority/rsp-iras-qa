...
When(
  ...
  async ({ reviewBodyProfilePage }, fieldKey: string) => {
    if (fieldKey === 'Organisation_Name') {
      await reviewBodyProfilePage.organisation_name_change_link.click();
    } else if (fieldKey === 'Country') {
      await reviewBodyProfilePage.country_change_link.click();
    } else if (fieldKey === 'Email_Address') {
      await reviewBodyProfilePage.email_address_change_link.click();
    } else if (fieldKey === 'Description') {
      await reviewBodyProfilePage.description_change_link.click();
    }
  }
);
